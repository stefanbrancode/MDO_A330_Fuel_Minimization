...
xS2 = AC.Wing.x(2) + AC.Struct.spar_front(2) * c(2);
xS3 = AC.Wing.x(3) + AC.Struct.spar_front(3) * c(3);
m_spar = (xS3 - xS2) / (y(3) - y(2));
xS1 = xS2 + m_spar * (y(1) - y(2));
AC.Struct.spar_front(1) =  (xS1 - AC.Wing.x(1)) / c(1);

xS2 = AC.Wing.x(2) + AC.Struct.spar_rear(2) * c(2);
xS3 = AC.Wing.x(3) + AC.Struct.spar_rear(3) * c(3);
m_spar = (xS3 - xS2) / (y(3) - y(2));
xS1 = xS2 + m_spar * (y(1) - y(2));
AC.Struct.spar_rear(1) =  (xS1 - AC.Wing.x(1)) / c(1);

% Tank Volume
AC = get_WingTankVolume(AC);
end
