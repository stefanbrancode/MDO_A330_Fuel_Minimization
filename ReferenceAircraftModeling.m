...
%% Range 
%Breguet eqs:
REF.Performance.eta = 1;
REF.Performance.CTbar= 1.8639*1e-4;
REF.Performance.CT = REF.Performance.CTbar / REF.Performance.eta;
REF.Performance.R = (REF.Mission.dp.V / REF.Performance.CT ) * (REF.L_over_D_aircraft) * log(REF.W.MTOW/REF.W.ZFW);
